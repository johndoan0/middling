...
var _BuilderManualDocBuilderJs = require('./Builder/ManualDocBuilder.js');

var _BuilderManualDocBuilderJs2 = _interopRequireDefault(_BuilderManualDocBuilderJs);

var _BuilderLintDocBuilderJs = require('./Builder/LintDocBuilder.js');

var _BuilderLintDocBuilderJs2 = _interopRequireDefault(_BuilderLintDocBuilderJs);
...
function publish(values, asts, config) {
  ...
  function writeHTML(html, fileName) {
    log(fileName);
    html = _PluginPluginJs2['default'].onHandleHTML(html);
  ...
  if (config.coverage) {
    new _BuilderCoverageBuilderJs2['default'](data, config).exec(writeCoverage, writeBadge);
  }
  ...
  new _BuilderManualDocBuilderJs2['default'](data, config).exec(writeHTML, copy);
  ...
  if (config.lint) {
    new _BuilderLintDocBuilderJs2['default'](data, config).exec();
  }
}
