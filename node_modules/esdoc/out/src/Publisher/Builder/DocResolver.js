...
var DocResolver = (function () {
  ...
  _createClass(DocResolver, [{
    ...
    value: function _resolveIgnore() {
      ...
      try {
        for (var _iterator = docs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          var longname = doc.longname.replace(/[$]/g, '\\$');
          var regex = new RegExp('^' + longname + '[.~#]');
     ...
     * @private
     */
    value: function _resolveNecessary() {
      var builder = this._builder;
      this._data({ 'export': false }).update(function () {
        var doc = this;
        var childNames = [];
        if (doc._custom_direct_subclasses) childNames.push.apply(childNames, _toConsumableArray(doc._custom_direct_subclasses));
        if (doc._custom_indirect_subclasses) childNames.push.apply(childNames, _toConsumableArray(doc._custom_indirect_subclasses));
        if (doc._custom_direct_implemented) childNames.push.apply(childNames, _toConsumableArray(doc._custom_direct_implemented));
        if (doc._custom_indirect_implemented) childNames.push.apply(childNames, _toConsumableArray(doc._custom_indirect_implemented));
        ...
        try {
          for (var _iterator11 = childNames[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
            var childName = _step11.value;

            var childDoc = builder._find({ longname: childName })[0];
    ...
    value: function _resolveTestRelation() {
      ...
      try {
        for (var _iterator12 = testDocs[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
          ...
          try {
            for (var _iterator14 = testTargets[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
              var testTarget = _step14.value;
      ...
      try {
        for (var _iterator13 = testDocs[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
          var testDoc = _step13.value;
          ...
          try {
            for (var _iterator15 = parents[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
    ...
    value: function _resolveDuplication() {
      ...
      try {
        for (var _iterator16 = docs[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
          var doc = _step16.value;

          // member duplicate with getter/setter/method.
          // when it, remove member.
          // getter/setter/method are high priority.
          var nonMemberDup = this._builder._find({ longname: doc.longname, kind: { '!is': 'member' } });
          if (nonMemberDup.length) {
            ignoreId.push(doc.___id);
            continue;
          }

          var dup = this._builder._find({ longname: doc.longname, kind: 'member' });
          if (dup.length > 1) {
