    ...
    value: function _inspectExportDefaultDeclaration() {
      ...
      try {
        for (var _iterator = this._ast.body[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          var pseudoClassExport = undefined;
          ...
          switch (exportNode.declaration.type) {
            case 'NewExpression':
              ...
              break;
            case 'Identifier':
              var varNode = _UtilASTUtilJs2['default'].findVariableDeclarationAndNewExpressionNode(exportNode.declaration.name, this._ast);
              if (varNode) {
                targetClassName = varNode.declarations[0].init.callee.name;
                targetVariableName = exportNode.declaration.name;
                pseudoClassExport = true;
                _UtilASTUtilJs2['default'].sanitize(varNode);
              } else {
          ...
          var classNode = _UtilASTUtilJs2['default'].findClassDeclarationNode(targetClassName, this._ast);
          if (classNode) {
            ...
            pseudoExportNode2.declaration = _UtilASTUtilJs2['default'].createVariableDeclarationAndNewExpressionNode(targetVariableName, targetClassName, exportNode.loc);

            pseudoExportNodes.push(pseudoExportNode1);
            pseudoExportNodes.push(pseudoExportNode2);

            _UtilASTUtilJs2['default'].sanitize(classNode);
            _UtilASTUtilJs2['default'].sanitize(exportNode);
          }

          var functionNode = _UtilASTUtilJs2['default'].findFunctionDeclarationNode(exportNode.declaration.name, this._ast);
          if (functionNode) {
            var pseudoExportNode = this._copy(exportNode);
            pseudoExportNode.declaration = this._copy(functionNode);
            _UtilASTUtilJs2['default'].sanitize(exportNode);
            _UtilASTUtilJs2['default'].sanitize(functionNode);
            pseudoExportNodes.push(pseudoExportNode);
          }

          var variableNode = _UtilASTUtilJs2['default'].findVariableDeclarationNode(exportNode.declaration.name, this._ast);
          if (variableNode) {
            var pseudoExportNode = this._copy(exportNode);
            pseudoExportNode.declaration = this._copy(variableNode);
            _UtilASTUtilJs2['default'].sanitize(exportNode);
            _UtilASTUtilJs2['default'].sanitize(variableNode);
            pseudoExportNodes.push(pseudoExportNode);
          }
        }
      } catch (err) {
        ...
        for (var _iterator2 = this._ast.body[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          if (exportNode.declaration && exportNode.declaration.type === 'VariableDeclaration') {
            ...
            try {
              for (var _iterator3 = exportNode.declaration.declarations[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                ...
                var classNode = _UtilASTUtilJs2['default'].findClassDeclarationNode(declaration.init.callee.name, this._ast);
                if (classNode) {
                  var pseudoExportNode = this._copy(exportNode);
          ...
          try {
            for (var _iterator4 = exportNode.specifiers[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
              ...
              var varNode = _UtilASTUtilJs2['default'].findVariableDeclarationAndNewExpressionNode(specifier.exported.name, this._ast);
              if (varNode) {
                targetClassName = varNode.declarations[0].init.callee.name;
                pseudoClassExport = true;
              ...
              var functionNode = _UtilASTUtilJs2['default'].findFunctionDeclarationNode(specifier.exported.name, this._ast);
              if (functionNode) {
                var pseudoExportNode = this._copy(exportNode);
                pseudoExportNode.declaration = this._copy(functionNode);
                pseudoExportNode.leadingComments = null;
              ...
              var variableNode = _UtilASTUtilJs2['default'].findVariableDeclarationNode(specifier.exported.name, this._ast);
              if (variableNode) {
                var pseudoExportNode = this._copy(exportNode);
                pseudoExportNode.declaration = this._copy(variableNode);
                pseudoExportNode.leadingComments = null;
